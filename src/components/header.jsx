...
import { BarIcon, SearchIcon, SettingsWhiteIcon, NotificationIcon, SearchWhiteIcon } from "../shared/icon";
        ...
        <div className="flex items-center xl:w-[calc(100%_-_326px)] md:w-[calc(100%_-_130px)] w-full md:pl-[0] pl-[15px]">
          <div className="mr-auto">
            <div className="flex items-center">
              ...
              <div className="px-[8px] block md:hidden"><Link href={'#'} onClick={() => setIsSearch(!isSearch)} ref={SearchIconRef}><SearchIcon width={23} height={23} color={'#FFFFFF'} /></Link></div>
